...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 Uᴩᴅᴀᴛᴇꜱ 📢', url=f'https://t.me/SA_update')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Sᴇᴀʀᴄʜ 🔎", url="https://t.me/allmovies_webserieshere"), 
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/SA_update")
            ],[      
